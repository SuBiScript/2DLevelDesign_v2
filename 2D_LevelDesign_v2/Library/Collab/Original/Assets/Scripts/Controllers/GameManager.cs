...
public class GameManager : MonoBehaviour
{
    ...
    private GameOverController youwinPanel;
    ...
    void Start()
    {
        ...
        pool.StorePoolerObject(3, gameManagerModel.GrenadeProjectile); // adding 2 player grenades in pooler*/
        ...
        youwinPanel = GetComponent<GameOverController>();
